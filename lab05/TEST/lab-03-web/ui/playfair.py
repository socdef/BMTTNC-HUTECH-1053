...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_info.setGeometry(QtCore.QRect(340, 70, 350, 30))
        font_info = QtGui.QFont()
        font_info.setPointSize(13)
        font_info.setItalic(True)
        self.label_info.setFont(font_info)
        self.label_info.setStyleSheet("color: #004d40;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_info.setText(_translate("MainWindow", "NGUYỄN THÁI HOÀNG - 2280601053"))
